...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    ...
    <div class="table-responsive">
        <table class="table table-striped">
            ...
            <tbody>
            <? foreach ($aboutUsContent as $curContent) : ?>
                <tr>
    ...
    <div class="row add-edit-block">
        <form class="data-form" action="AdminAboutUs/Edit" method="post">
...
<script type="text/javascript" src="../../../webroot/js/Admin/aboutUs.js"></script>